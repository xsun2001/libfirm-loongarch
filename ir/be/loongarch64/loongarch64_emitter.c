 ...
 */
static void emit_loongarch64_Jmp(const ir_node *node)
{
	loongarch64_emitf(node, "jmp %L", node);
}
...
static void loongarch64_register_emitters(void)
{
	...
	be_set_emitter(op_loongarch64_Jmp,    emit_loongarch64_Jmp);
	be_set_emitter(op_loongarch64_Return, emit_Return);
 ...
 */
static void  eloongarch64_emit_block(ir_node *block)
{
